    ...
    <section id="decision" className="border-y border-[#d9d1c7] bg-[#f1ede8] px-5 py-16 sm:px-8 lg:px-12 lg:py-24" aria-label="FitCheck decision demo">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2">
          <article className="border border-[#c8d8d7] bg-[#eaf3f2] p-6"><div className="flex items-center justify-between gap-3"><p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#39716e]">Skin AI · mock-first</p><span className="bg-[#39716e] px-2 py-1 text-[9px] font-bold uppercase tracking-[0.15em] text-white">Cosmetic only</span></div><h3 className="mt-3 font-serif text-2xl text-[#172b3a]">A calm finishing pass.</h3><p className="mt-2 text-sm leading-6 text-[#53615f]">Skin AI can turn a permitted selfie into appearance guidance for camera confidence. It does not diagnose, judge, or change the outfit decision.</p><div className="mt-4 flex flex-wrap items-center gap-4"><p className="text-xs font-semibold text-[#39716e]">Mock by default · live when configured</p><a href="/demo" className="border-b border-[#39716e]/40 pb-1 text-xs font-bold uppercase tracking-[0.12em] text-[#39716e] hover:border-[#39716e]">Try Skin AI demo →</a></div></article>
