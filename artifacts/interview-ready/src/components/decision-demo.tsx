        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="border border-[#d6c1a8] bg-[#f8eee3] p-6">
              ...
              <p className="mt-4 min-h-5 text-xs font-semibold text-[#70442b]" role="status" aria-live="polite">{feedback ? `✓ ${feedbackCopy[feedback]}` : "Tell us what to change in this demo session."}</p><p className="mt-2 text-[11px] text-[#8a5b40]">Not saved, not used to train or personalize future calls.</p>
            </div>
          </div>
        </div>
