...
const signals = [
  ...
  ["02", "Reference wardrobe first", "One complete demo answer from clearly labeled wardrobe references before any shopping suggestion."],
